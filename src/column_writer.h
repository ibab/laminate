...
#ifndef LAMINATE_COLUMN_WRITER_H
#define LAMINATE_COLUMN_WRITER_H
...
class ColumnWriter {
  ...
  std::vector<std::vector<const google::protobuf::FieldDescriptor*>>
  Descriptors();
...
#endif  // LAMINATE_COLUMN_WRITER_H
